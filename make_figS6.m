function out = make_figS6(csvfile, outdir)
%MAKE_FIGS6  Rate estimation, clustering, and what the intervals rest on.
%
...
%
%  Usage:  out = make_figS6('sciadv_adt8600_data_s1.csv', 'output');
%
%  ZPK 2026
...
P.B = 4000;
% SAME seed as make_fig4's bootstrap_joint and make_figS5 (opts.seed =
...
% stream already advanced by 4000 iid replicates and cannot match make_fig4,
