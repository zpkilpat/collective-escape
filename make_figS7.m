function out = make_figS7(csvfile, xlsfile, outdir)
%MAKE_FIGS7  Area scaling and shoal density: what Data S2 does and does not
%            license.
%
...
%
%  Usage:  out = make_figS7('sciadv_adt8600_data_s1.csv', ...
