...
%MAKE_FIGS5  The over-discounting gap does not depend on the attended count.
%
%  This is the panel retired from the main empirical figure, which belongs
%  in the supplement:
...
P.B    = 4000;
% SAME seed and replicate count as make_fig4's bootstrap_joint (opts.seed =
